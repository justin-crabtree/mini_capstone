...
product = Product.new(
  name: "Cyberpunk 2077", 
  price: 59.99, 
  image_url: "https://images.app.goo.gl/M8nswBEGbw3dbsAP8", 
...
product = Product.new(
  name: "Doom Eternal", 
  price: 59.99, 
  image_url: "https://images.app.goo.gl/N6XeQQDL8LtFRu2PA", 
...
product = Product.new(
  ...
  price: 59.99, 
  image_url: "https://images.app.goo.gl/ZoMGsT5mnoGHCT6P6", 
